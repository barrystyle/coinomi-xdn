...
import com.coinomi.core.coins.DigitalNoteMain;
import com.coinomi.core.coins.DigitalNoteTest;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(DigitalNoteMain.get(),      new ServerAddress("", 50001))
    );
    ...
    static {
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.BITCOIN_MAIN.getCoinType(), "http://explorer2.digitalnote.biz/tx/%s");
    }

    public static final CoinType DEFAULT_COIN = DigitalNoteMain.get();
    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType) DigitalNoteMain.get());
    public static final ArrayList<String> DEFAULT_TEST_COIN_IDS = Lists.newArrayList(
            DigitalNoteTest.get().getId()
    );
