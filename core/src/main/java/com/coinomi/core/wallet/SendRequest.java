...
public class SendRequest<T extends AbstractTransaction> implements Serializable {
    ...
    /**
     * The blockchain network (DigitalNote, Dogecoin,..) that this request is going to transact
     */
     ...
     * is how mining is incentivized in later years of the DigitalNote system when inflation drops. It also provides
     ...
     * blockchain i.e. DigitalNote, Litecoin messages could be stored on a public server
     */
