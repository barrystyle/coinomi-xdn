...
public final class MonetaryFormat implements Serializable {
    ...
    /** Currency code for base 1 DigitalNote. */
    public static final String CODE_BTC = "BTC";
    /** Currency code for base 1/1000 DigitalNote. */
    public static final String CODE_MBTC = "mBTC";
    /** Currency code for base 1/1000000 DigitalNote. */
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for DigitalNote
