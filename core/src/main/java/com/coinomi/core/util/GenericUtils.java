...
//        return fixed;
    ...
    public static List<CoinType> getPossibleTypes(String addressStr) throws AddressMalformedException {
        ...
        tryDigitalNoteFamilyAddresses(addressStr, builder);
    ...
    /**
     * Tries to parse the addressStr as a DigitalNote style address and find potential compatible coin types
     * @param addressStr possible bitcoin type address
     * @param builder for the types list
     */
    private static void tryDigitalNoteFamilyAddresses(final String addressStr, ImmutableList.Builder<CoinType> builder) {
